...
Use this index to find the public contracts, evidence, and user guides for
XIVLegacy Tools.
...
| [GTEX fields and PWIB segments](formats/gtex-pwib.md) | Loader-backed texture fields and split-container boundaries |
